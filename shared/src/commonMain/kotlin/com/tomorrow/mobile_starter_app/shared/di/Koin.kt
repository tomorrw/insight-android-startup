package com.tomorrow.mobile_starter_app.shared.di

import com.tomorrow.mobile_starter_app.shared.data.data_source.local.LocalDatabase
import com.tomorrow.mobile_starter_app.shared.data.data_source.local.LocalDatabaseImplementation
import com.tomorrow.mobile_starter_app.shared.data.data_source.remote.ApiService
import com.tomorrow.mobile_starter_app.shared.data.data_source.remote.ApiServiceImplementation
import com.tomorrow.mobile_starter_app.shared.data.data_source.remote.WebSocketService
import com.tomorrow.mobile_starter_app.shared.data.data_source.remote.WebSocketServiceImplementation
import com.tomorrow.mobile_starter_app.shared.data.repository.RepositoryImplementation
...
private fun commonModule(enableNetworkLogs: Boolean) = module {
    ...
    single<com.tomorrow.mobile_starter_app.shared.data.data_source.local.EncryptedStorage> {
        com.tomorrow.mobile_starter_app.shared.data.data_source.local.EncryptedStorageImplementation(
            get(named(com.tomorrow.mobile_starter_app.shared.data.data_source.local.EncryptedStorageImplementation.SETTING_NAME)),
            get()
        )
    }
...
class BearerTokensContainer(private val encryptedLocalDatabase: com.tomorrow.mobile_starter_app.shared.data.data_source.local.EncryptedStorage) :
    KoinScopeComponent {
