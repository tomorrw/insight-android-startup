...
import com.tomorrow.lda.shared.data.data_source.local.LocalDatabaseImplementation
import com.tomorrow.lda.shared.data.data_source.remote.ApiService
import com.tomorrow.lda.shared.data.data_source.remote.ApiServiceImplementation
import com.tomorrow.lda.shared.data.repository.RepositoryImplementation
import com.tomorrow.lda.shared.domain.model.MultipleFieldValidationError
...
private fun commonModule(enableNetworkLogs: Boolean) = module {
    ...
    single<com.tomorrow.lda.shared.data.data_source.local.EncryptedStorage> {
        com.tomorrow.lda.shared.data.data_source.local.EncryptedStorageImplementation(
            get(named(com.tomorrow.lda.shared.data.data_source.local.EncryptedStorageImplementation.SETTING_NAME)),
            get()
        )
    }
...
class BearerTokensContainer(private val encryptedLocalDatabase: com.tomorrow.lda.shared.data.data_source.local.EncryptedStorage) :
    KoinScopeComponent {
