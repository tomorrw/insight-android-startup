package com.tomorrow.lda.feature_navigation
...
import com.tomorrow.lda.shared.di.Constants
import com.tomorrow.lda.views.AskLectureQuestionView
import com.tomorrow.lda.views.CategoryView
import com.tomorrow.lda.views.ClaimedOffers
import com.tomorrow.lda.views.CompaniesByMap
import com.tomorrow.lda.views.CompaniesView
import com.tomorrow.lda.views.CompanyView
import com.tomorrow.lda.views.DailyLecturesView
import com.tomorrow.lda.views.EventDetailsView
import com.tomorrow.lda.views.ExhibitionsView
import com.tomorrow.lda.views.HomeView
import com.tomorrow.lda.views.LecturesView
import com.tomorrow.lda.views.LoginView
import com.tomorrow.lda.views.MyLecturesView
import com.tomorrow.lda.views.MyQrView
import com.tomorrow.lda.views.OTPView
import com.tomorrow.lda.views.OffersAndDeals
import com.tomorrow.lda.views.OnBoardingView
import com.tomorrow.lda.views.PostView
import com.tomorrow.lda.views.ProductCategoriesView
import com.tomorrow.lda.views.ProfileView
import com.tomorrow.lda.views.RegisterView
import com.tomorrow.lda.views.SettingsView
import com.tomorrow.lda.views.SpeakerDetailView
import com.tomorrow.lda.views.SpeakersView
