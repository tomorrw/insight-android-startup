package com.tomorrow.lda.feature_in_app_update
...
import com.tomorrow.lda.feature_in_app_update.components.FlexibleUpdateDialog
import com.tomorrow.lda.feature_in_app_update.components.ForceUpdateDialog
import com.tomorrow.lda.shared.domain.use_cases.GetUpdateTypeUseCase
...
fun InAppUpdater(
    ...
    when {
        isForceUpdateDialogVisible.value -> ForceUpdateDialog { context.openUpdatePageInPlayStore() }
