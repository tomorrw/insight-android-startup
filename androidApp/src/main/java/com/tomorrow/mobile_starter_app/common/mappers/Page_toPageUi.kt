package com.tomorrow.mobile_starter_app.common.mappers

import androidx.compose.ui.graphics.Color
import com.tomorrow.mobile_starter_app.packageImplementation.mappers.toEvent
import com.tomorrow.mobile_starter_app.common.Section
import com.tomorrow.mobile_starter_app.shared.domain.model.Page

fun Page.toPageUi(eventColor: Color? = null) =
    com.tomorrow.mobile_starter_app.common.Page(this.title, this.sections.map { section ->
        when (section) {
